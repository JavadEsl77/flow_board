...
import {deleteTask} from "../../config/fetchData";
...
const DeleteTaskModal = ({openModal, closeModal, boardId, projectId,taskId, didUpdate}: props) => {
    ...
    const requestDeleteTask = async () => {
        setError('')
        setIsLoading(true)
        return await deleteTask(projectId, boardId , taskId)
    }

    const handlerDeleteTask = () => {
        requestDeleteTask().then((response) => {
                    ...
                    <Box sx={style}>
                        ...
                        <Box sx={{display: "flex", marginTop: error ? "0.2em" : "2em"}}>
                            ...
                            <Box sx={{display: "flex", alignItems: "center"}}>
                                ...
                                }} variant="contained" onClick={() => handlerDeleteTask()}>Delete</Button>
