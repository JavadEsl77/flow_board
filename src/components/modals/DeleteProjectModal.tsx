...
import {deleteProject} from "../../config/fetchData";
...
const DeleteProjectModal = ({openModal, closeModal, projectId, didUpdate}: props) => {
    ...
    const handlerDeleteProject = () => {
        requestDeleteProject().then((response) => {
                    ...
                    <Box sx={style}>
                        ...
                        <Box sx={{display: "flex", marginTop: error ? "0.2em" : "2em"}}>
                            ...
                            <Box sx={{display: "flex", alignItems: "center"}}>
                                ...
                                }} variant="contained" onClick={() => handlerDeleteProject()}>Delete</Button>
